...
int alterarcliente(cliente *x)
{
        ...
        long int inser;
        system ("cls");
        printf("Qual o Numero do aluno que quer alterar? "); /* [Necessita ser modificado] */
        scanf("%ld",&inser);
        for(n=1;n<NR;n++)
        {
                if(x[n].estado!=1)
